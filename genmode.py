...
out = pvo(outcar)
ibrion = out.getParam('IBRION', int)
if ibrion != 5:
...
if args.mode is None:
    modes = [i for i in range(out.DOF)]
else:
    modes = [args.mode]
